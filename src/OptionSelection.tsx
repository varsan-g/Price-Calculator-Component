        ...
        <div>
            ...
            <div className="flex justify-center flex-wrap">
                {options.map((option) => (
                    ...
                    >
                        <div className="rounded-2xl flex items-align justify-center shadow-md cursor-pointer p-10 text-white hover-gradient" style={{ backgroundColor: '#0e0e0e', height: 'auto' }}>
                            <lord-icon
                                src={option.lordicon}
                                trigger="hover"
                                stroke="bold"
